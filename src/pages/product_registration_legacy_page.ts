...
function CustomRegistrable<TBase extends GConstructor<RegistrationBaseLegacyPage>>(Base: TBase) {
...
export class ProductRegistrationLegacyPage extends RegistrationBaseLegacyPage {}
export class CustomRegistrationLegacyPage extends CustomRegistrable(RegistrationBaseLegacyPage) {}
